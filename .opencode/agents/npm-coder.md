...
Message parent: node /Users/twaldin/openfleet/bin/send --to-parent --sender npm-coder --message "<update>"
...
1. Save state to ~/.openfleet/agents/npm-coder/MEMORY.md
2. Append today's key events to ~/.openfleet/agents/npm-coder/memory/YYYY-MM-DD.md
