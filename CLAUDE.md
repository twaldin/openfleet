...
Message parent: node /Users/twaldin/openfleet/bin/send --to-parent --sender cleanup-coder --message "<update>"
...
1. Save state to ~/.openfleet/agents/cleanup-coder/MEMORY.md
2. Append today's key events to ~/.openfleet/agents/cleanup-coder/memory/YYYY-MM-DD.md
