...
Message parent: node /Users/twaldin/openfleet/bin/send --to-parent --sender fix-coder --message "<update>"
...
1. Save state to ~/.openfleet/agents/fix-coder/MEMORY.md
2. Append today's key events to ~/.openfleet/agents/fix-coder/memory/YYYY-MM-DD.md
